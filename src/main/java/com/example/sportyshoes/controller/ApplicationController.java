...
public class ApplicationController {
    ...
    public String updateUser(@RequestParam("uloginid") String uloginid,
                             @RequestParam("upassword") String upassword, @RequestParam("uemail") String uemail, @RequestParam("uphone") String uphone) {
    ...
    public ModelAndView placeOrder(@RequestParam("lid") String lid) {
        ...
        List<OrderDetails> userOrderDetails =
                orderDetailsService.getUserOrderDetails(orderid);
